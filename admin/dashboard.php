...
<head>
	...
	<title>Vehicle Rental System | Admin Dashboard</title>
...
?>
											...
											<a href="reg-users.php" class="block-anchor panel-footer text-center">Info <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
?>
											...
											<a href="manage-vehicles.php" class="block-anchor panel-footer text-center">Info <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
?>
											...
											<a href="manage-bookings.php" class="block-anchor panel-footer text-center">Info <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-3">
										<div class="panel panel-default">
...
?>												
											...
											<a href="manage-brands.php" class="block-anchor panel-footer text-center">Info <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
...
?>
											...
											<a href="testimonials.php" class="block-anchor panel-footer text-center">Info <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
...
?>
											...
											<a href="manage-conactusquery.php" class="block-anchor panel-footer text-center">Info <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
